 ...
 *
 * {@link ImageReader} をもとに実装.
 */
class Camera2MJPEGPreviewServerOld implements PreviewServer {
    ...
    Camera2MJPEGPreviewServerOld(final Camera2Recorder recorder) {
        mRecorder = recorder;
    }
    ...
    public void startWebServer(final OnWebServerStartCallback callback) {
        synchronized (mLockObj) {
            ...
            if (mServer == null) {
                ...
                mServer.setServerName("HostDevicePlugin Server (Old)");
                mServer.setPort(9100);

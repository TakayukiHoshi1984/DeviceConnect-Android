...
public class FrameBasedH264Stream extends FrameBasedVideoStream {

    private MP4Config mConfig;

	public FrameBasedH264Stream(final SharedPreferences prefs, final VideoQuality quality) throws IOException {
		super(prefs, quality);
